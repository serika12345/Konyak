...
import 'program_profile_manifest_codec.dart';

export 'program_profile_manifest_codec.dart';
...
class DartIoInstallProfileLibrary implements InstallProfileLibrary {
  ...
  InstallProfileLibraryResult exportProfile({
    ...
    return profile.match(
      ...
      (profile) {
        final bytes = canonicalInstallProfileManifestBytes(profile);
  ...
  _UserProfileValidationResult _validatedUserProfile(String sourcePath) {
    ...
    try {
      ...
      final canonicalBytes = canonicalInstallProfileManifestBytes(parsed);
