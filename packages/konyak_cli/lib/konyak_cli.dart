...
part 'src/domain/program/pe_program_icons.dart';
part 'src/io/pe_program_icon_io.dart';
part 'src/domain/program/pe_program_image.dart';
part 'src/io/pe_program_resources.dart';
part 'src/domain/program/pe_program_versions.dart';
...
part 'src/domain/program/program_registry_parsers.dart';
part 'src/domain/program/program_winetricks_support.dart';
