...
void main() {
  ...
  for (final invalidStorageIdCase in const [
    (label: 'dot', value: '.'),
    (label: 'dot-dot', value: '..'),
    (label: 'forward separator', value: 'bad/id'),
    (label: 'back separator', value: r'bad\id'),
    (label: 'NUL', value: 'bad\u0000id'),
    (label: 'blank', value: '   '),
    (label: 'leading whitespace', value: ' steam'),
    (label: 'trailing whitespace', value: 'steam '),
  ]) {
    test('rejects ${invalidStorageIdCase.label} bottle storage id', () {
      final result = parseBottleListPayload('''
        {
          "schemaVersion": 1,
          "bottles": [],
          "invalidBottles": [
            {
              "storageId": ${jsonEncode(invalidStorageIdCase.value)},
              "path": "/bottles/invalid",
